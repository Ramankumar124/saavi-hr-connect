...
const ServicesSection = () => {
  const services = [
    {
      ...
      description:
        "End-to-end recruitment solutions including temporary & permanent staffing and executive search.",
      features: [
        "Temp Staffing",
        "Permanent Placement",
        "Executive Search",
    ...
    },
    {
      ...
      description:
        "Complete payroll management services with accuracy, compliance, and timely processing.",
      features: [
        "Salary Processing",
        "Tax Calculations",
        "Compliance Reports",
    ...
    },
    {
      ...
      description:
        "Comprehensive compliance management for PF, ESI, PT, LWF and other statutory requirements.",
      features: [
        "PF Management",
        "ESI Processing",
        "Professional Tax",
...

    {
      ...
      description:
        "Thorough vendor assessments and quality inspections to ensure standards.",
      features: [
        "Vendor Assessment",
        "Quality Audits",
        "Compliance Check",
  ...
  const getColorClasses = (color: string) => {
    const colorMap = {
      ...
      "corporate-accent":
        "bg-corporate-accent/10 text-corporate-accent border-corporate-accent/20",
      "corporate-blue-light":
        "bg-corporate-blue-light/10 text-corporate-blue-light border-corporate-blue-light/20",
    };
    return (
      colorMap[color as keyof typeof colorMap] || colorMap["corporate-blue"]
    );
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
            From recruitment to compliance like wise, We provide end-to-end HR
          ...
          {services.map((service, index) => (
            ...
            >
              <CardHeader className="pb-3 sm:pb-4">
                <div
                  className={`p-2 sm:p-3 rounded-lg w-fit mb-3 sm:mb-4 ${getColorClasses(
                    service.color
                  )}`}
                >
                  <service.icon className="h-5 w-5 sm:h-6 sm:w-6" />
                </div>
                <CardTitle className="text-lg sm:text-xl text-corporate-grey-dark group-hover:text-corporate-blue transition-colors">
                  {service.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
